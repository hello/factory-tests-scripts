...
messages = []
messages.append({"action":"connect_serial","port":2,"purpose":"uut", "baudrate":19200, "parity":'N', "stopbits":1,"bytesize":8})
messages.append({"action":"enable_recording","purpose":"uut"})
#messages.append({"action":"serial_message","message":"boot","purpose":"uut"})
messages.append({"action":"serial_message","purpose":"uut","message":"SYST:REM\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"INST FIR\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"VOLT 24.0V\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"CURR 0.5A\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"VOLT:PROT 10V\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"INST SECO\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"VOLT 12.0V\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"CURR 0.5A\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"VOLT:PROT 10V\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"INST THI\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"VOLT 5.25V\n"})
messages.append({"action":"serial_message","purpose":"uut","message":"CURR 2A\n"})
